...
public class Person {
     ...
     * @return the person
     */
    public static Person input(CollectionManager collectionManager) {
        String name = inputName();
        LocalDateTime birthday = inputBirthday();
        int height = inputHeight();
        double weight = inputWeight();
        String passportId = inputPassportId(collectionManager);
     ...
     */
    private static String inputPassportId(CollectionManager collectionManager) {
        ...
        if (passportId.length() > 41) {
            ...
            return inputPassportId(collectionManager);
        }
        if (collectionManager.containsPassport(passportId)) {
